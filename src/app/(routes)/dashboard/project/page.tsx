...
export default function Page(){
    ...
    <div className="w-[13rem] bg-neutral-600 h-[15rem] rounded-[5%] flex flex-col justify-center items-center"><Link href="/dashboard/todo/2" className="hover:text-zinc-50">todos</Link></div>
